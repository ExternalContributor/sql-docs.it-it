...
SQL Server 2017 viene ora eseguito in Linux. È lo stesso motore di database di SQL Server, con molte funzionalità e i servizi simili indipendentemente dal sistema operativo utilizzato.
